...
const STAND = Symbol("stand"), WALK_LEFT = Symbol("walk left"), WALK_RIGHT = Symbol("walk right"), HIGH_KICK = Symbol("high kick"), JUMP = Symbol("jump"), UNDEFINED = Symbol("undefined"), vIndex2Symbol = [STAND, WALK_LEFT, WALK_RIGHT, HIGH_KICK, JUMP];
